    ...
    <div className="navbar bg-orange-800 h-28 mb-4 rounded">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow  bg-orange-800   rounded-box w-52 text-end">
        ...
        <img className='rounded-full h-12 w-12'  src={icon}  />
          <span className="font-4xl text-white">Heros</span>
        </Link>
      </div>
