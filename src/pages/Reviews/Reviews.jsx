...
<div className="hero bg-base-200" data-aos="fade-up"data-aos-duration="3000">
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div >
      ...
      <p className="py-6">Each Happy Meal box includes one of eight super hero toys based on characters from the super hero toys baby toys  and will be available for a limited time at participating restaurants nationwide, while supplies last..</p>
